...
<div class="Titles">
	<h2 class="ExerciseTitle">10) Complete o programa em C correspondente &#x00E0; cria&#x00E7;&#x00E3;o de um vetor de 5 posi&#x00E7;&#x00F5;es.</h2>
<br />
...
<div class="ClozeBody">
#include <stdio.h><br />#include <stdlib.h><br />#include <conio.h><br />main()<br />{<br /><br />int vetor [5];<br />int i;<br /><br /><span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="19"></input></span> <br />{<br /><br />printf ("\nescreva os valores:");// escrita dos valores<br />scanf ("%d", &vetor[i]);// leitura dos valores<br />}<br />getch();<br />}<br />
</div>
</form>
</div>
...
<a href="convergente_medio_9.php"> Anterior </a>
