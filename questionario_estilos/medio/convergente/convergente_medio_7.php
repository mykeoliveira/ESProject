...
<div class="Titles">
	<h2 class="ExerciseTitle">7) Associe como Certo ou Errado as declara&#x00E7;&#x00F5;es de scanf</h2>
...
<tr><td class="LeftItem">scanf("%d",&var);</td><td class="RightItem"><select id="s0_0"><option value="x"></option>
<option value="1">Errado</option>
<option value="0">Correto</option>
</select></td><td></td></tr><tr><td class="LeftItem">scanf("%c,&var");</td><td class="RightItem"><select id="s1_1"><option value="x"></option>
<option value="1">Errado</option>
<option value="0">Correto</option>
</select></td><td></td></tr><tr><td class="LeftItem">scanf(%d,&var);</td><td class="RightItem"><select id="s1_2"><option value="x"></option>
<option value="1">Errado</option>
<option value="0">Correto</option>
</select></td><td></td></tr><tr><td class="LeftItem">scanf("%c"&var);</td><td class="RightItem"><select id="s1_3"><option value="x"></option>
<option value="1">Errado</option>
<option value="0">Correto</option>
</select></td><td></td></tr><tr><td class="LeftItem">scanf(%c",&var);</td><td class="RightItem"><select id="s0_4"><option value="x"></option>
<option value="1">Errado</option>
<option value="0">Correto</option>
</select></td><td></td></tr>
...
<a href="convergente_medio_6.php"> Anterior </a>
<a href="convergente_medio_8.php"> Próximo </a>
</div>
