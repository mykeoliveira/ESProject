...
<div class="Titles">
	<h2 class="ExerciseTitle">2) Observando a estrutura de um programa na linguagem C, complete o programa que soma cinco valores e mostre sua m&#x00E9;dia.</h2>
...
<div class="ClozeBody">
main()<br />{<br /> int v1, v2, v3, v4, v5, <span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>, <span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>;<br /><br /> soma= v1+v2+v3+v4+v5;<br /><br /> media=<span class="GapSpan" id="GapSpan2"><input type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>/<span class="GapSpan" id="GapSpan3"><input type="text" id="Gap3" onfocus="TrackFocus(3)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>;<br /> printf("A m&#x00E9;dia dos valores &#x00E9; %<span class="GapSpan" id="GapSpan4"><input type="text" id="Gap4" onfocus="TrackFocus(4)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>", <span class="GapSpan" id="GapSpan5"><input type="text" id="Gap5" onfocus="TrackFocus(5)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>);<br /><br /> getch();<br />}
</div>
</form>
</div>
...
<a href="convergente_medio_1.php"> Anterior </a>
<a href="convergente_medio_3.php"> Próximo </a>
</div>
