...
<div class="Titles">
	<h2 class="ExerciseTitle">4) Relacione: </h2>
...
<tr><td class="LeftItem">Inteiro</td><td class="RightItem"><select id="s0_0"><option value="x"></option>
<option value="0">1, -5, 100</option>
<option value="1">1.3, -3.5, 0.55</option>
<option value="2">nome, sexo</option>
</select></td><td></td></tr><tr><td class="LeftItem">Real</td><td class="RightItem"><select id="s1_1"><option value="x"></option>
<option value="0">1, -5, 100</option>
<option value="1">1.3, -3.5, 0.55</option>
<option value="2">nome, sexo</option>
</select></td><td></td></tr><tr><td class="LeftItem">Caracter</td><td class="RightItem"><select id="s2_2"><option value="x"></option>
<option value="0">1, -5, 100</option>
<option value="1">1.3, -3.5, 0.55</option>
<option value="2">nome, sexo</option>
</select></td><td></td></tr>
...
<a href="divergente_basico_3.php"> Anterior </a>
<a href="divergente_basico_5.php"> Próximo </a>
</div>
