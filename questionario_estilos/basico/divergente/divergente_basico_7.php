...
<div class="Titles">
	<h2 class="ExerciseTitle">7) Fa&#x00E7;a o teste de mesa e complete a tabela</h2>
...
<div class="ClozeBody">
algoritmo_Obtem_Conceito_Aluno <br />declare <br />int: P1, P2, P3, P4; <br />real: media; <br />inicio <br />leia(P1,P2,P3,P4); <br />media &#x2190; (P1+P2+P3+P4) / 4; <br />escreva(media); <br />se media &lt; 6 entao <br />escreva(&#x201C;REPROVADO&#x201D;); <br />senao <br />escreva(&#x201C;APROVADO&#x201D;); <br />fim-se <br />fim <br />fim-algoritmo <br />Valores das Entradas: P1 = 5, P2 = 6, P3 =8 e P4 = 4<br /><br />Teste1	 P1	P2 	P3	P4	Media	Media &lt; 6<br />Declare				<span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>	<span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>	<span class="GapSpan" id="GapSpan2"><input type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> <span class="GapSpan" id="GapSpan3"><input type="text" id="Gap3" onfocus="TrackFocus(3)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> <br />int: P1, P2, P3, P4;						<br />real: media;						<br />Inicio						<br />leia(P1, P2, P3, P4);	 5	6	8	4		<br />media&lt;-(P1+P2+P3+P4)/4;	5	6	8	4	5,75	<br />escreva(media); 	 5	6	8	4 5,75	<br />se media &lt; 6 entao	 5	6	8	4	5,75	true<br />Demais comandos	 5	6	8	4	5,75	true<br /><br /><br /><br />
</div>
</form>
</div>
...
<a href="divergente_basico_6.php"> Anterior </a>
<a href="divergente_basico_8.php"> Próximo </a>
