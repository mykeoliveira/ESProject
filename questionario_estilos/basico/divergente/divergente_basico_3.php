...
I[0][1] = new Array();
I[0][1][0] = new Array();
I[0][1][0][0] = '\u0072\u0065\u0061\u006C\u003A\u0020\u006D\u0065\u0064\u0069\u0061\u003B';
I[0][2]='';

I[1] = new Array();
I[1][1] = new Array();
I[1][1][0] = new Array();
I[1][1][0][0] = '\u006C\u0065\u0069\u0061\u0028\u0050\u0031\u002C\u0020\u0050\u0032\u002C\u0020\u0050\u0033\u002C\u0020\u0050\u0034\u0029\u003B';
I[1][2]='';
...
<div class="Titles">
	<h2 class="ExerciseTitle">3) Analisando o seguinte algoritmo em pseudoc&#x00F3;digo complete:</h2>
...
<div class="ClozeBody">
<br />algoritmo_Media_Final <br />declare <br />inteiro: P1, P2, P3, P4; <br /><span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="12"></input></span> <br />inicio <br /><span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="21"></input></span> <br />media &#x2190; (P1+P2+P3+P4)/4; <br />escreva(media); <br />fim <br />fim_algoritmo<br />
</div>
</form>
</div>
...
<a href="divergente_basico_2.php"> Anterior </a>
<a href="divergente_basico_4.php"> Próximo </a>
