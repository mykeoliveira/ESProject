...
<div class="Titles">
	<h2 class="ExerciseTitle">6) Relacione o tipo com o exemplo</h2>
...
<tr><td class="LeftItem">Dados fornecidos pelo usu&#x00E1;rio </td><td class="RightItem"><select id="s0_0"><option value="x"></option>
<option value="3">ate resp = &#x201C;N&#x201D; </option>
<option value="4">atualizado &#x2190; &#x201C;N&#x201D;; /* N&#x00E3;o L&#x00F3;gico */ atualizado &#x2190; False; /* L&#x00F3;gico */ </option>
<option value="2">cont &#x2190; cont + 1; /* Conta */ soma &#x2190; soma + num; /*Acumula*/ </option>
<option value="0">leia(nome, idade); </option>
<option value="1">area &#x2190; base * altura; </option>
</select></td><td></td></tr><tr><td class="LeftItem">Resultados de express&#x00F5;es </td><td class="RightItem"><select id="s1_1"><option value="x"></option>
<option value="3">ate resp = &#x201C;N&#x201D; </option>
<option value="4">atualizado &#x2190; &#x201C;N&#x201D;; /* N&#x00E3;o L&#x00F3;gico */ atualizado &#x2190; False; /* L&#x00F3;gico */ </option>
<option value="2">cont &#x2190; cont + 1; /* Conta */ soma &#x2190; soma + num; /*Acumula*/ </option>
<option value="0">leia(nome, idade); </option>
<option value="1">area &#x2190; base * altura; </option>
</select></td><td></td></tr><tr><td class="LeftItem">Acumuladores/Contadores </td><td class="RightItem"><select id="s2_2"><option value="x"></option>
<option value="3">ate resp = &#x201C;N&#x201D; </option>
<option value="4">atualizado &#x2190; &#x201C;N&#x201D;; /* N&#x00E3;o L&#x00F3;gico */ atualizado &#x2190; False; /* L&#x00F3;gico */ </option>
<option value="2">cont &#x2190; cont + 1; /* Conta */ soma &#x2190; soma + num; /*Acumula*/ </option>
<option value="0">leia(nome, idade); </option>
<option value="1">area &#x2190; base * altura; </option>
</select></td><td></td></tr><tr><td class="LeftItem">Finalizadores de repeti&#x00E7;&#x00F5;es </td><td class="RightItem"><select id="s3_3"><option value="x"></option>
<option value="3">ate resp = &#x201C;N&#x201D; </option>
<option value="4">atualizado &#x2190; &#x201C;N&#x201D;; /* N&#x00E3;o L&#x00F3;gico */ atualizado &#x2190; False; /* L&#x00F3;gico */ </option>
<option value="2">cont &#x2190; cont + 1; /* Conta */ soma &#x2190; soma + num; /*Acumula*/ </option>
<option value="0">leia(nome, idade); </option>
<option value="1">area &#x2190; base * altura; </option>
</select></td><td></td></tr><tr><td class="LeftItem">Sinalizadores/Flags </td><td class="RightItem"><select id="s4_4"><option value="x"></option>
<option value="3">ate resp = &#x201C;N&#x201D; </option>
<option value="4">atualizado &#x2190; &#x201C;N&#x201D;; /* N&#x00E3;o L&#x00F3;gico */ atualizado &#x2190; False; /* L&#x00F3;gico */ </option>
<option value="2">cont &#x2190; cont + 1; /* Conta */ soma &#x2190; soma + num; /*Acumula*/ </option>
<option value="0">leia(nome, idade); </option>
...
<a href="divergente_basico_5.php"> Anterior </a>
<a href="divergente_basico_7.php"> Próximo </a>
</div>
...
Para acessar os materiais complementares, clique na figura abaixo.<br /><br />
         <a target="_blank" href="http://arquivos.unicruz.edu.br/myke/questionario_estilos/basico/divergente/divergente_basico.php">  <img src="../../../images/img1.png"  title="" width="80" height="80"/> </a>
